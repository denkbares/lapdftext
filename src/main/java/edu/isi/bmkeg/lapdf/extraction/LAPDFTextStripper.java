 ...
 */
public class LAPDFTextStripper extends PDFStreamEngine {

	private static final String thisClassName = LAPDFTextStripper.class.getSimpleName()
			.toLowerCase();
	...
	// TODO.
	//
	// WE ARE CHEATING HERE AND USING PDFBOX TO GENERATE LAPDF XML
...
//        		"t=\"" + text + "\" " +
				"font=\"" + p1.getFont().getBaseFont() + "\">" + text + "</wd>\n");
